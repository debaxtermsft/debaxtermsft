$tId = "tenantid"  # Add tenant ID from Azure Active Directory page on portal.
...
Connect-MgGraph -Scopes "AuditLog.Read.All, directory.read.all" -TenantId $tId  # Or use Directory.Read.All.
...
$legacy = Get-MgAuditLogSignIn -all -Filter "createdDateTime ge $startDate"  | 
