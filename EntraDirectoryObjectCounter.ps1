...
# Additionally to view the current object counts
...
#write-host "Total counted objects : " $objects
#write-host "Directory Quota Used : " $used
#write-host "Directory Quota Total : " $total
#write-host "Directory Quota Remaining : " $remaining
